...
export class Pool extends Entity {
  ...
  get prepaymentAbsorbedAmount(): BigInt {
    let value = this.get("prepaymentAbsorbedAmount");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set prepaymentAbsorbedAmount(value: BigInt) {
    this.set("prepaymentAbsorbedAmount", Value.fromBigInt(value));
  }
  ...
  get pStartFrom(): BigInt {
    let value = this.get("pStartFrom");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set pStartFrom(value: BigInt) {
    this.set("pStartFrom", Value.fromBigInt(value));
  }

  get pRepayFrequency(): BigInt {
    let value = this.get("pRepayFrequency");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set pRepayFrequency(value: BigInt) {
...
export class Transaction extends Entity {
  ...
  get lenderOrBorrower(): Bytes {
    let value = this.get("lenderOrBorrower");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set lenderOrBorrower(value: Bytes) {
    this.set("lenderOrBorrower", Value.fromBytes(value));
  }
...
export class ConsumerCoordinatorPair extends Entity {
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save ConsumerCoordinatorPair entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ConsumerCoordinatorPair must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("ConsumerCoordinatorPair", id.toString(), this);
    }
  }

  static loadInBlock(id: string): ConsumerCoordinatorPair | null {
    return changetype<ConsumerCoordinatorPair | null>(
      store.get_in_block("ConsumerCoordinatorPair", id),
    );
  }

  static load(id: string): ConsumerCoordinatorPair | null {
    return changetype<ConsumerCoordinatorPair | null>(
      store.get("ConsumerCoordinatorPair", id),
    );
  }
